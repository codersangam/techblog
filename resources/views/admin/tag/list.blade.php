                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-danger" href="{{"/admin/tag/delete/".$list['id']}}" onclick="return confirm('Are you sure?');">Delete</a>
                        </td>
                    </tr>
                    <?php $Sno++ ?>
                    @endforeach
            ...
            <form action="add" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group mb-4">
                        ...
                        <input type="text" class="form-control" id="formGroupExampleInput" name="title" placeholder="Example: Red">
                    </div>
                    <div class="form-group mb-4">
                        <label for="formGroupExampleInput2">Slug</label>
                        <input type="text" class="form-control" id="formGroupExampleInput2" name="slug" placeholder="Example: red">
                    </div>
                </div>
