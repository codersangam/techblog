                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                            <div class="single-post-media">
                                <img src="{{ Storage::disk('local')->url($post->featuredimage) }}" alt=""
                                    class="img-fluid">
                            </div><!-- end media -->
                            <div class="blog-title-area text-left">
                                ...
                                <div class="row ml-1">
                                    @foreach ($post->categories as $category)
                                        <span class="color-orange pr-2"><a href="{{ route('category', $category->slug) }}"
                            ...
                            <div class="blog-title-area">
                                <div class="tag-cloud-single">
                                    ...
                                    @foreach ($post->tags as $tag)
                                        <small><a href="{{ route('tag', $tag->slug) }}"
                                        ...
                                        <div class="blog-list-widget">
                                            <div class="list-group">
                                                @if (isset($post->previous))
                                                    <a href="{{ route('post', $post->previous->slug) }}"
                                                        class="list-group-item list-group-item-action flex-column align-items-start">
                                                        <div class="w-100 justify-content-between text-right">
                                                            <img src="{{ Storage::disk('local')->url($post->previous->featuredimage) }}"
                                                ...
                                                @if (isset($post->next))
                                                    <a href="{{ route('post', $post->next->slug) }}"
                                                        ...
                                                        <div class="w-100 justify-content-between text-left">
                                                            <img src="{{ Storage::disk('local')->url($post->next->featuredimage) }}"
                            ...
                            <div class="custombox authorbox clearfix">
                                ...
                                <div class="row">
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                        ...
                                        <img src="{{ Storage::disk('local')->url($post->user->profile_photo_path) }}"
                                                ...
                                                <div class="blog-box">
                                                    <div class="post-media">
                                                        <a href="tech-single.html" title="">
                                                            <img src="{{ Storage::disk('local')->url($random_post->featuredimage) }}"
                                                                alt="" class="img-fluid">
                                            ...
                                            <div class="list-group">
                                                <a href="{{ route('post', $post->slug) }}"
                                                    ...
                                                    <div class="w-100 justify-content-between">
                                                        <img src="{{ Storage::disk('local')->url($post->featuredimage) }}"
                                                            alt="" class="img-fluid float-left">
